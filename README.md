<html>
  ...
  <body>
    ...
    <p>
      ...
      so instead im going to do more CSS and HTML tricks until i figure out JS. <class id = "fontExample">this whole text should be a different font or font size</class> 
    </p>

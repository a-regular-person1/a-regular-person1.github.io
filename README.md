<html>
  ...
  <body>
    ...
    <p>
      ...
      so instead im going to do more CSS and HTML tricks until i figure out JS. <class id = "fontExample">this whole text should be a different font or font size.</class>I am not sure what else to do without the ability to use buttons or jQuery which I could not figure out how to get working with gitHub pages so i am going to have links to my projects on Kahn Academy, a great place to learn programing
      <href = https://www.khanacademy.org/computer-programming/spin-off-of-project-hoppy-beaver-extreme/5230581102198784>here is a game made by me with the help of khan academy </href>
    </p>
